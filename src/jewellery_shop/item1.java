...
public class item1 extends JFrame {
	public item1() {
		...
		JLabel t2 = new JLabel("ITEM NAME:-> Yellow gold earring");
		...
		JLabel t5 = new JLabel("TOTAL:-> 85,015");
		...
		ImageIcon item = new ImageIcon("item11.jpeg");
