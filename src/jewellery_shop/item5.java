...
public class item5 extends JFrame {
	public item5() {
		...
		JLabel t2 = new JLabel("ITEM NAME:-> Yellow Gold Neckless");
		t2.setBounds(300, 10, 500, 200);
		JLabel t3 = new JLabel("SIZE:-> 11.38 Gram");
		t3.setBounds(300, 50, 500, 200);
		JLabel t4 = new JLabel("PURITY:-> 22 K");
		t4.setBounds(300, 90, 500, 200);
		JLabel t5 = new JLabel("TOTAL:-> 1,03,694");
		...
		ImageIcon item = new ImageIcon("item15.jpeg");
		...
		b1.addActionListener(new ActionListener(){
			  ...
			  payment s=new payment("1,03,694/-");
			  setVisible(false);
			  }
			  });
