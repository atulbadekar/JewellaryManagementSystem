...
public class item7 extends JFrame {
	public item7() {
		...
		JLabel t2 = new JLabel("ITEM NAME:-> Yellow Gold Bangles");
		t2.setBounds(300, 10, 500, 200);
		JLabel t3 = new JLabel("SIZE:-> 11.75 Gram");
		t3.setBounds(300, 50, 500, 200);
		JLabel t4 = new JLabel("PURITY:-> 22 KT");
		t4.setBounds(300, 90, 500, 200);
		JLabel t5 = new JLabel("TOTAL:-> 1,12,035");
		...
		ImageIcon item = new ImageIcon("item17.jpeg");
		...
		b1.addActionListener(new ActionListener(){
			  ...
			  payment s=new payment("1,12,035/-");
			  setVisible(false);
			  }
			  });
